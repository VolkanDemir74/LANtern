...
async function loadSettings() {
  ...
  $('openPanelOnStartup').checked=value.openPanelOnStartup;
...
async function saveSettings() {
  ...
  const value={startWithWindows:$('startWithWindows').checked,autoConnectVirtualDisplay:$('autoConnectMonitor').checked,
    autoStartStream:$('autoStartStream').checked,autoStartWhenMonitorConnect:$('autoStartOnMonitorConnect').checked,openPanelOnStartup:$('openPanelOnStartup').checked,
