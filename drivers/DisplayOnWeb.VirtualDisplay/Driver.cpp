...
void IndirectDeviceContext::InitAdapter()
{
    ...
    AdapterCaps.EndPointDiagnostics.pEndPointFriendlyName = L"LANtern Virtual Monitor";
    AdapterCaps.EndPointDiagnostics.pEndPointManufacturerName = L"LANtern";
    AdapterCaps.EndPointDiagnostics.pEndPointModelName = L"LAN Display 1080p";
...
void IndirectDeviceContext::FinishInit(UINT ConnectorIndex)
{
    ...
    // Expose an EDID-less 1080p60 monitor so Windows cannot inherit an
    // ultrawide physical-display mode.
